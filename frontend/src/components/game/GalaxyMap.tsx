                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className={`${selectedPlanetState?.bossDefeated ? 'text-green-400' : 'text-orange-400'}`}>
                      ...
                      {selectedPlanetData.secretBoss && (
                        <div className="flex justify-between">
                          ...
                          <span className={`${selectedPlanetState?.secretBossDefeated ? 'text-green-400' : 'text-purple-400'}`}>
